...
module.exports = {
  data: new SlashCommandBuilder().setName('nofication').setDescription('お知らせを送信しましす').setDMPermission(false).addChannelOption(function (option) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            imgfileOption = interaction.options.get('imgfile');
            imgfile = imgfileOption ? imgfileOption.url : null;
            client = interaction.client;
            modal = new ModalBuilder().setCustomId('sendmessage').setTitle('お知らせ送信内容');
